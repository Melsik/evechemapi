...
class EquipmentUpdate(Model):
    ...
    """
    def __init__(self, contains: int=None, last_updated: int=None, online: bool=None, resource: int=None, name: str=None):
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this EquipmentUpdate.

        :return: The name of this EquipmentUpdate.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str):
        """
        Sets the name of this EquipmentUpdate.

        :param name: The name of this EquipmentUpdate.
        :type name: str
        """
